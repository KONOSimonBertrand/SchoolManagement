...
{
    partial class EditPaymentMeanForm
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            levelLabel = new Telerik.WinControls.UI.RadLabel();
            typeSeparator = new Telerik.WinControls.UI.RadSeparator();
            typeDropDownList = new Telerik.WinControls.UI.RadDropDownList();
            ...
            ((System.ComponentModel.ISupportInitialize)typeDropDownList).BeginInit();
            ...
            editPanel.Controls.Add(levelLabel);
            editPanel.Controls.Add(typeSeparator);
            editPanel.Controls.Add(typeDropDownList);
            ...
            ((Telerik.WinControls.Primitives.BorderPrimitive)typeDropDownList.GetChildAt(0).GetChildAt(0)).Visibility = Telerik.WinControls.ElementVisibility.Collapsed;
            ((Telerik.WinControls.UI.AutoCompleteSuggestDropDownListElement)typeDropDownList.GetChildAt(0).GetChildAt(3)).Visibility = Telerik.WinControls.ElementVisibility.Hidden;
            ((Telerik.WinControls.UI.AutoCompleteSuggestDropDownListElement)typeDropDownList.GetChildAt(0).GetChildAt(3)).MaxSize = new Size(0, 1);
            ((Telerik.WinControls.Primitives.BorderPrimitive)typeDropDownList.GetChildAt(0).GetChildAt(3).GetChildAt(0)).Visibility = Telerik.WinControls.ElementVisibility.Visible;
            // 
            // typeLabel
            // 
            ...
            ((System.ComponentModel.ISupportInitialize)typeDropDownList).EndInit();
