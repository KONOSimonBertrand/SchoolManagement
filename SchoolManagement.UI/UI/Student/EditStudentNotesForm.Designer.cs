...
{
    partial class EditStudentNotesForm
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            evaluationLabel.DisplayName = "Evaluation";
            ...
            exportToExelButton.DisplayName = "Export Button";
            ...
            // groupSeparator
            // 
            groupSeparator.DisplayName = "Expot Button Separator";
            ...
            // groupLabel
            // 
            groupLabel.DisplayName = "Groupe";
            groupLabel.Name = "groupLabel";
            groupLabel.Text = "Section";
            // 
            // groupDropDownList
            // 
            groupDropDownList.DisplayName = "Group";
            ...
            informationPanel.Controls.Add(noteMaxLabel);
            ...
            noteCoefTextBox.Location = new Point(683, 12);
            noteCoefTextBox.Margin = new Padding(4, 5, 4, 5);
            noteCoefTextBox.Name = "noteCoefTextBox";
            noteCoefTextBox.ReadOnly = true;
            noteCoefTextBox.Size = new Size(51, 36);
            noteCoefTextBox.TabIndex = 124;
            // 
            // noteCoefLabel
            // 
            noteCoefLabel.AutoSize = false;
            noteCoefLabel.Location = new Point(597, 17);
            noteCoefLabel.Margin = new Padding(4, 5, 4, 5);
            noteCoefLabel.Name = "noteCoefLabel";
            noteCoefLabel.Size = new Size(82, 18);
            noteCoefLabel.TabIndex = 125;
            noteCoefLabel.Text = "Coefficient:";
            // 
            // noteMaxTextBox
            // 
            noteMaxTextBox.AutoSize = false;
            noteMaxTextBox.Location = new Point(827, 12);
            noteMaxTextBox.Margin = new Padding(4, 5, 4, 5);
            noteMaxTextBox.Name = "noteMaxTextBox";
            noteMaxTextBox.ReadOnly = true;
            noteMaxTextBox.Size = new Size(80, 36);
            noteMaxTextBox.TabIndex = 124;
            // 
            // noteMaxLabel
            // 
            noteMaxLabel.AutoSize = false;
            noteMaxLabel.Location = new Point(741, 17);
            noteMaxLabel.Margin = new Padding(4, 5, 4, 5);
            noteMaxLabel.Name = "noteMaxLabel";
            noteMaxLabel.Size = new Size(82, 18);
            noteMaxLabel.TabIndex = 125;
            noteMaxLabel.Text = "Note max:";
            // 
            // subjectDropDownList
            // 
            subjectDropDownList.AutoCompleteMode = AutoCompleteMode.Suggest;
            subjectDropDownList.DropDownAnimationEnabled = true;
            subjectDropDownList.Location = new Point(78, 12);
            subjectDropDownList.Name = "subjectDropDownList";
            subjectDropDownList.Size = new Size(507, 24);
            subjectDropDownList.TabIndex = 0;
            // 
            // subjectLabel
            // 
            subjectLabel.Location = new Point(12, 17);
            subjectLabel.Name = "subjectLabel";
            subjectLabel.Size = new Size(47, 18);
            subjectLabel.TabIndex = 71;
            ...
            // filterTextBox
            // 
            filterTextBox.Location = new Point(79, 7);
            filterTextBox.Name = "filterTextBox";
            filterTextBox.NullText = "Rechercher par ....";
            filterTextBox.Size = new Size(506, 30);
            filterTextBox.TabIndex = 1;
            // 
            // filterLabel
            // 
            filterLabel.Location = new Point(12, 15);
            filterLabel.Margin = new Padding(4, 5, 4, 5);
