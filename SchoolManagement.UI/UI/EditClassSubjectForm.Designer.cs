namespace SchoolManagement.UI
{
    partial class EditClassSubjectForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            noteOnTextBox = new Telerik.WinControls.UI.RadTextBox();
            noteOnLabel = new Telerik.WinControls.UI.RadLabel();
            coefLabel = new Telerik.WinControls.UI.RadLabel();
            coefTextBox = new Telerik.WinControls.UI.RadTextBox();
            ...
            ((System.ComponentModel.ISupportInitialize)noteOnTextBox).BeginInit();
            ((System.ComponentModel.ISupportInitialize)noteOnLabel).BeginInit();
            ((System.ComponentModel.ISupportInitialize)coefLabel).BeginInit();
            ((System.ComponentModel.ISupportInitialize)coefTextBox).BeginInit();
            ...
            editPanel.Controls.Add(noteOnSeparator);
            editPanel.Controls.Add(coefSeparator);
            editPanel.Controls.Add(noteOnTextBox);
            editPanel.Controls.Add(noteOnLabel);
            editPanel.Controls.Add(coefLabel);
            editPanel.Controls.Add(coefTextBox);
            editPanel.Controls.Add(sequenceSeparator);
            editPanel.Controls.Add(subjectSeparator);
            editPanel.Controls.Add(addSubjectButton);
            ...
            // sectionSeparator
            // 
            sectionSeparator.Location = new Point(421, 139);
            sectionSeparator.Margin = new Padding(5, 6, 5, 6);
            sectionSeparator.Name = "sectionSeparator";
            sectionSeparator.Size = new Size(213, 5);
            sectionSeparator.TabIndex = 121;
            sectionSeparator.TabStop = false;
            // 
            // sectionDropDownList
            // 
            ...
            ((Telerik.WinControls.Primitives.BorderPrimitive)sectionDropDownList.GetChildAt(0).GetChildAt(0)).Visibility = Telerik.WinControls.ElementVisibility.Collapsed;
            ((Telerik.WinControls.UI.AutoCompleteSuggestDropDownListElement)sectionDropDownList.GetChildAt(0).GetChildAt(3)).Visibility = Telerik.WinControls.ElementVisibility.Hidden;
            ((Telerik.WinControls.UI.AutoCompleteSuggestDropDownListElement)sectionDropDownList.GetChildAt(0).GetChildAt(3)).MaxSize = new Size(0, 1);
            ((Telerik.WinControls.Primitives.BorderPrimitive)sectionDropDownList.GetChildAt(0).GetChildAt(3).GetChildAt(0)).Visibility = Telerik.WinControls.ElementVisibility.Visible;
            // 
            // sectionLabel
            // 
            sectionLabel.AutoSize = false;
            sectionLabel.Location = new Point(421, 76);
            sectionLabel.Margin = new Padding(5, 6, 5, 6);
            sectionLabel.Name = "sectionLabel";
            sectionLabel.Size = new Size(213, 30);
            sectionLabel.TabIndex = 119;
            sectionLabel.Text = "Section:";
            // 
            // groupLabel
            // 
            groupLabel.AutoSize = false;
            groupLabel.Location = new Point(421, 2);
            groupLabel.Margin = new Padding(5, 6, 5, 6);
            groupLabel.Name = "groupLabel";
            groupLabel.Size = new Size(374, 30);
            groupLabel.TabIndex = 117;
            groupLabel.Text = "Groupe:";
            // 
            // groupSeparator
            // 
            groupSeparator.Location = new Point(421, 65);
            groupSeparator.Margin = new Padding(5, 6, 5, 6);
            groupSeparator.Name = "groupSeparator";
            groupSeparator.Size = new Size(374, 5);
            ...
            // noteOnSeparator
            // 
            noteOnSeparator.Location = new Point(122, 132);
            noteOnSeparator.Margin = new Padding(4, 5, 4, 5);
            noteOnSeparator.Name = "noteOnSeparator";
            noteOnSeparator.Size = new Size(112, 4);
            noteOnSeparator.TabIndex = 108;
            noteOnSeparator.TabStop = false;
            // 
            // coefSeparator
            // 
            coefSeparator.Location = new Point(2, 132);
            coefSeparator.Margin = new Padding(4, 5, 4, 5);
            coefSeparator.Name = "coefSeparator";
            coefSeparator.Size = new Size(112, 4);
            coefSeparator.TabIndex = 107;
            coefSeparator.TabStop = false;
            // 
            // noteOnTextBox
            // 
            noteOnTextBox.AutoSize = false;
            ...
            // noteOnLabel
            // 
            noteOnLabel.AutoSize = false;
            noteOnLabel.Location = new Point(122, 71);
            noteOnLabel.Margin = new Padding(4, 5, 4, 5);
            noteOnLabel.Name = "noteOnLabel";
            noteOnLabel.Size = new Size(106, 30);
            noteOnLabel.TabIndex = 111;
            noteOnLabel.Text = "Notée sur:";
            // 
            // coefLabel
            // 
            coefLabel.AutoSize = false;
            coefLabel.Location = new Point(5, 71);
            coefLabel.Margin = new Padding(4, 5, 4, 5);
            coefLabel.Name = "coefLabel";
            coefLabel.Size = new Size(106, 30);
            coefLabel.TabIndex = 112;
            coefLabel.Text = "Coefficient:";
            // 
            // coefTextBox
            // 
            coefTextBox.AutoSize = false;
            ...
            // sequenceSeparator
            // 
            sequenceSeparator.Location = new Point(243, 132);
            sequenceSeparator.Margin = new Padding(4, 5, 4, 5);
            sequenceSeparator.Name = "sequenceSeparator";
            sequenceSeparator.Size = new Size(104, 4);
            sequenceSeparator.TabIndex = 107;
            sequenceSeparator.TabStop = false;
            // 
            // subjectSeparator
            // 
            subjectSeparator.Location = new Point(3, 65);
            subjectSeparator.Margin = new Padding(4, 5, 4, 5);
            subjectSeparator.Name = "subjectSeparator";
            subjectSeparator.Size = new Size(364, 4);
            subjectSeparator.TabIndex = 105;
            subjectSeparator.TabStop = false;
            // 
            // addSubjectButton
            // 
            addSubjectButton.ImageAlignment = ContentAlignment.MiddleCenter;
            ...
            sequenceLabel.Location = new Point(243, 71);
            sequenceLabel.Margin = new Padding(4, 5, 4, 5);
            sequenceLabel.Name = "sequenceLabel";
            sequenceLabel.Size = new Size(104, 30);
            sequenceLabel.TabIndex = 102;
            sequenceLabel.Text = "Séquence:";
            // 
            // subjectLabel
            // 
            subjectLabel.AutoSize = false;
            subjectLabel.Location = new Point(0, 4);
            subjectLabel.Margin = new Padding(4, 5, 4, 5);
            subjectLabel.Name = "subjectLabel";
            subjectLabel.Size = new Size(367, 30);
            subjectLabel.TabIndex = 64;
            subjectLabel.Text = "Matière:";
            ((Telerik.WinControls.UI.RadLabelElement)subjectLabel.GetChildAt(0)).Text = "Matière:";
            ((Telerik.WinControls.UI.RadLabelElement)subjectLabel.GetChildAt(0)).AutoSize = true;
            // 
            // errorLabel
            // 
            errorLabel.AutoSize = false;
            errorLabel.Location = new Point(0, 160);
            errorLabel.Margin = new Padding(4, 5, 4, 5);
            errorLabel.Name = "errorLabel";
            errorLabel.Size = new Size(595, 30);
            ...
            ((System.ComponentModel.ISupportInitialize)sectionSeparator).EndInit();
            ((System.ComponentModel.ISupportInitialize)sectionDropDownList).EndInit();
            ...
            ((System.ComponentModel.ISupportInitialize)noteOnTextBox).EndInit();
            ((System.ComponentModel.ISupportInitialize)noteOnLabel).EndInit();
            ((System.ComponentModel.ISupportInitialize)coefLabel).EndInit();
            ((System.ComponentModel.ISupportInitialize)coefTextBox).EndInit();
        ...
        private Telerik.WinControls.UI.RadTextBox noteOnTextBox;
        private Telerik.WinControls.UI.RadLabel noteOnLabel;
        private Telerik.WinControls.UI.RadLabel coefLabel;
        private Telerik.WinControls.UI.RadTextBox coefTextBox;
        private Telerik.WinControls.UI.RadSeparator noteOnSeparator;
        private Telerik.WinControls.UI.RadSeparator sequenceSeparator;
        private Telerik.WinControls.UI.RadSeparator coefSeparator;
        ...
        private Telerik.WinControls.UI.RadSeparator sectionSeparator;
        private Telerik.WinControls.UI.RadDropDownList sectionDropDownList;
