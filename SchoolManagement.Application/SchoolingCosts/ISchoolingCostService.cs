...
namespace SchoolManagement.Application
{
    public  interface ISchoolSchoolingCostService
    {
        ...
        public Task<IList<SchoolingCost>> GetSchoolingCostList(List<int> classIdList, int cashFlowTypeId, int schoolYearId);
        public Task<IList<SchoolingCost>> GetSchoolingCostList( int cashFlowTypeId, int schoolYearId);
