...
{
    internal class FoundationAnnualReportCardReport : SchoolManagement.UI.Reporting.FoundationEvaluationReport
    
    {

        public FoundationAnnualReportCardReport(TermReportCard reportCard)
        {
            string img = reportCard.HeadSection.Language == "FR" ? "head_paper_fr.png" : "head_paper_en.png";
            HeaderPictureBox.Value = AppUtilities.GetImageFromUrl(img);
