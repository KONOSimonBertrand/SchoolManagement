...
{
    public class FoundationTermReportCardReport : SchoolManagement.UI.Reporting.FoundationEvaluationReport
    {
        public FoundationTermReportCardReport(TermReportCard reportCard)
        {
