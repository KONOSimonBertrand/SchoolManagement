    ...
    public partial class MainForm
    {
        ...
        private void LoadSelectedSubjectGroupDetail(SubjectGroup subjectGroup)
        {
            if (subjectGroup != null)
            {
                ...
                subjectGroupInfo.NameTextBox.Text = Thread.CurrentThread.CurrentUICulture.Name == "en-GB"?subjectGroup.EnglishName:subjectGroup.FrenchName;
            }
        }
        ...
        private void LoadSelectedSubjectDetail(Subject subject)
        {
            if (subject != null)
            {
                ...
                subjectInfo.NameTextBox.Text = Thread.CurrentThread.CurrentUICulture.Name == "en-GB" ?subject.EnglishName : subject.FrenchName;
            }
        }
        ...
        private void LoadSelectedEvaluationSesssionDetail(EvaluationSession evaluationSession)
        {
            if (evaluationSession != null)
            {
                ...
                evaluationSessionInfo.NameTextBox.Text = evaluationSession.ToString();
            }
        }
        ...
        private void LoadSelectedRatingSystemDetail(RatingSystem ratingSystem)
        {
            if (ratingSystem != null)
            {
                ...
                ratingSystemInfo.NameTextBox.Text = Thread.CurrentThread.CurrentUICulture.Name == "en-GB" ? ratingSystem.EnglishName: ratingSystem.FrenchName;
        ...
        {
            var getData = evaluationSessionService.GetEvaluationSessionListAsync();
        ...
        private void CreateRatingSystemColumnsForSettingGridView()
        {
            using (SettingGridView.DeferRefresh())
            {
                ...
                GridViewTextBoxColumn domainColumn = new("Domain");
                ...
                SettingGridView.Columns.Add(domainColumn);
            }
        ...
        private async void GenerateEmptyClassReport(SchoolRoom selectedRoom, SchoolYear selectedYear)
        {
            var form = Program.ServiceProvider.GetService<ReportViewerForm>();
            form.GenerateEmptyReportClassNote(selectedRoom, selectedYear);
            form.Icon = this.Icon;
                ...
                if (SettingLeftListView.SelectedItem != null)
                {
                    switch (SettingLeftListView.SelectedItem.Key)
                    {
                        ...
                        case 7:
                            ...
                            break;
                        case 8:
                             e.Visible &= e.Row.Cells["CashFlowType.Name"].Value.ToString().ToLower().Contains(this.SettingSearchTextBox.Text.ToLower()) ||
                                e.Row.Cells["SchoolYear.Name"].Value.ToString().ToLower().Contains(this.SettingSearchTextBox.Text.ToLower());
                            break;
                        case 9:
            ...
            if (!e.ContextMenuProvider.ToString().Contains("Header"))
            {
                ...
                switch (SettingLeftListView.SelectedItem.Key)
                {
                    ...
                    case 8:
                        ...
                        break;
                        case 11:
                            if(SettingGridView.CurrentRow.DataBoundItem is EvaluationSession session)
                        {
        ...
        private void MenuGenerateEmptyClassReport_Click(object sender, EventArgs e)
        {
            ...
            switch (SettingLeftListView.SelectedItem.Key)
            {
                case 3:
                    if (SettingGridView.CurrentRow.DataBoundItem is SchoolClass selectedClass)
                    {
                        foreach (var room in Program.SchoolRoomList)
                        {
                            ...
                            {
                                GenerateEmptyClassReport(room, Program.CurrentSchoolYear);
                            }
                        }
                    }
                    break; 
                case 4:
                    ...
                    {
                        GenerateEmptyClassReport(selectedRoom, Program.CurrentSchoolYear);
                    }
                    break;
            }
